/*
Задание 2
Мы ловко упорядочили животных по убыванию веса, отсортировав по возрастанию -weight. Но с именем так не выйдет. 
...
Здесь будет достаточно любого решения, даже с небольшим копированием кода. Например, можно начать функцию с if (reverse) и 
в каждой ветке отсортировать с нужным компаратором.
*/
#include <algorithm>
#include <iostream>
#include <vector>
...
void SortBy(Container& container, KeyMapper key_mapper, bool reverse = 0 /*or = false*/) {
    if (reverse) {
