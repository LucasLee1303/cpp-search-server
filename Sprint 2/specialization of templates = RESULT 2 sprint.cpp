...
Достаточно написать новый метод — vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status) const. А в нём одну строчку: создали нужную 
лямбду и вызвали основную версию одноимённого метода.
