...
using tuple_match_doc_t = std::tuple<std::vector<std::string_view>, DocumentStatus>;
...
public:
    ...
    tuple_match_doc_t MatchDocument(std::string_view raw_query, int document_id) const;

    tuple_match_doc_t MatchDocument(const std::execution::sequenced_policy& policy, std::string_view raw_query, int document_id) const;

    tuple_match_doc_t MatchDocument(const std::execution::parallel_policy& policy, std::string_view raw_query, int document_id) const;
...
private:
    ...
    Query ParseQuery(std::string_view text, bool par = true) const;
